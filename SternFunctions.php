	...
	<table class="form-table">
		...
		<tr>
			...
			<td>
				...
				<input type="checkbox" id="pharmacist" name="pharmacist" value="1" <?php if(esc_attr( get_the_author_meta( 'pharmacist', $user->ID ) )) {echo "checked";} else {echo"";} ?> /><br />
...
function arrayStatutAction($statut)
{
    $arrayStatutAction = array(
        ...
        '2' => __('Start preparation' , 'SternUPAC'),
        '3' => __('Finish preparation' , 'SternUPAC'),
        '4' => __('Prescription received and paid' , 'SternUPAC'),
		'5' => __('Prescription almost done' , 'SternUPAC'),
		'10' => __('Validate other document' , 'SternUPAC'),
		'50' => __('Order being validated' , 'SternUPAC'),
