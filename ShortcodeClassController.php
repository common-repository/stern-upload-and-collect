...
class ShortcodeClass{
	...
	//	$type_user = getTypeUser($atts);
		...
		if ($pharmacist !=1 and $pharmacist !="on") {
			echo  __('Sorry, you must be a pharmacist for this area.1' , 'SternUPAC'); 
		} else {
    ...
    public function showFilesShortcode( $atts, $content ) {
		...
		*/
		...
		$pharmacist = esc_attr( get_the_author_meta( 'pharmacist',  get_current_user_id()) ) ;
	//	if ($pharmacist !=1 and $pharmacist !="on") {
	//		echo  __('Sorry, you must be a pharmacist for this area.2' , 'SternUPAC'); 
	//	} else {
	...
	public function showMutuelleListAdminShortcode() {
		...
		$pharmacist = esc_attr( get_the_author_meta( 'pharmacist',  get_current_user_id()) ) ;
		if ($pharmacist !=1 and $pharmacist !="on") {
			echo  __('Sorry, you must be a pharmacist for this area.3' , 'SternUPAC'); 
		} else {
