...
Class showMutuelleListAdminTemplate{
    function __construct($the_query)
    {
		if (is_user_logged_in()){
			...
			echo __( 'Other document', 'stern-ticketing-events'). '<br>';
			$toggle = 4; 
			...
			<table width="100%" class="table">
				<thead>
					<tr>				
						<th>
						<?php _e( 'Download', 'stern-ticketing-events'); ?>
						</th>
						<th>
						<?php _e( 'Delete', 'stern-ticketing-events'); ?>
						</th>
						<th>
						<?php _e( 'Author', 'stern-ticketing-events'); ?>
						</th>						
						<th>
						<?php _e( 'Name File', 'stern-ticketing-events'); ?>
						</th>
						<th>
						<?php _e( 'End of validty / Status', 'stern-ticketing-events'); ?>
						</th>
						<th>
						<?php _e( 'Audit', 'stern-ticketing-events'); ?>
						</th>
					</tr>
				</thead>
				<tbody>
